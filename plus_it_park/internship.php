   ...
   <div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="assets/img/sbg6.png">
      <div class="container">
        <div class="cs-page_heading_in">
          <h1 class="cs-page_title cs-font_50 cs-white_color">Deschooling</h1>
        ...
        <div class="row align-items-center cs-column_reverse_lg">
          ...
          <div class="col-lg-6 offset-lg-1">
            <div class="cs-section_heading cs-style1">
              ...
              <br>
              <p><b style="font-size: 18px; color: #ff3399;" >Brochures</b></p>
              ...
              <li>
                <a href="#" class="cs-text_btn cs-type2">
                  ...
                  <span>Web 3 Blockchain Development</span>              
                </a>
              </li>
              <li>
                <a href="#" class="cs-text_btn cs-type2">
    ...
    <div class="container">
      <div class="cs-portfolio_1_heading">
        <div class="cs-section_heading cs-style1">
          <!-- <h3 class="cs-section_subtitle">Deschooling Program</h3> -->
          <h2 class="cs-section_title" >Internship Program</h2>
        </div>
        <div class="cs-isotop_filter cs-style1">
          <ul class="cs-mp0 cs-center">
            ...
            <li>
              <a href="#" data-filter=".portrait">Web Development</a>
            </li>
            <li>
              <a href="#" data-filter=".fashion">Flutter Development</a>
            </li>
            <li>
        ...
        <div class="cs-isotop cs-style1 cs-isotop_col_4 cs-has_gutter_24 cs-lightgallery">
          <div class="cs-grid_sizer"></div>
           ...
           <div class="cs-isotop_item wedding">
            <!-- <a href="assets/img/portfolio_28_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2"> -->
              ...
              <!-- <div class="cs-portfolio_bg cs-bg" data-src="assets/img/in7.jpg"></div> -->
              <h3>Web 3 Blockchain</h3>
              <p style="text-align:justify;">The Blockchain Internship Program at Plus IT Business Park, Thrissur, is your exciting gateway to exploring the world of blockchain technology. Here, you'll actively engage in real-time projects, assignments, and hands-on experience with various test networks. Our program goes beyond theory, providing comprehensive training on frameworks like Ether.js, Web3.js, and application development using the LENS Protocol. In addition, we offer training on web frameworks like React and Vite. Moreover, we provide instruction on a wide array of tools like Hardhat, Remix, and concepts such as NFTs, ensuring a rich foundation for a successful career as a Blockchain Developer. Encompassing experience that equips you with the skills and knowledge you need to excel in the blockchain industry.</p>
            ...
            <a href="internship" class="cs-text_btn">
              <span>More About Web 3 Development</span>
              <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M25.5303 6.53033C25.8232 6.23744 25.8232 5.76256 25.5303 5.46967L20.7574 0.696699C20.4645 0.403806 19.9896 0.403806 19.6967 0.696699C19.4038 0.989593 19.4038 1.46447 19.6967 1.75736L23.9393 6L19.6967 10.2426C19.4038 10.5355 19.4038 11.0104 19.6967 11.3033C19.9896 11.5962 20.4645 11.5962 20.7574 11.3033L25.5303 6.53033ZM0 6.75H25V5.25H0V6.75Z" fill="currentColor"></path>
              </svg>
            </a>
          ...
          <div class="cs-isotop_item portrait">
            <!-- <a href="assets/img/portfolio_25_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2"> -->
              ...
              <p style="text-align:justify;">The Web Development Internship Program at Plus IT Business Park is your gateway to mastering the art of creating dynamic and responsive web applications. Through our program, you'll receive comprehensive training in developing web applications with HTML5 and cutting-edge UI development using tools like Bootstrap and Tailwind. Furthermore, we go the extra mile by offering training in MERN (MongoDB, Express, React, Node.js) stack development. You'll work with various NoSQL and SQL databases, equipping you with the skills and knowledge required to become a versatile Full Stack Developer, perfectly aligned with the demands of the industry. Embark on a journey that will empower you to excel in the field of web development and meet the ever-evolving needs of the digital landscape.</p>
              <!-- <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">web 3 Development</h2>
                <div class="cs-portfolio_subtitle">View Large</div>
              </div> -->
            <!-- </a> -->
             <div class="cs-height_40 cs-height_lg_40"></div>
            <a href="../internship/web_development.html" class="cs-text_btn">
              <span>More About Web Development</span>
              <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M25.5303 6.53033C25.8232 6.23744 25.8232 5.76256 25.5303 5.46967L20.7574 0.696699C20.4645 0.403806 19.9896 0.403806 19.6967 0.696699C19.4038 0.989593 19.4038 1.46447 19.6967 1.75736L23.9393 6L19.6967 10.2426C19.4038 10.5355 19.4038 11.0104 19.6967 11.3033C19.9896 11.5962 20.4645 11.5962 20.7574 11.3033L25.5303 6.53033ZM0 6.75H25V5.25H0V6.75Z" fill="currentColor"></path>
              </svg>
            </a>
          ...
          <div class="cs-isotop_item fashion">
            <!-- <a href="#" class="cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2"> -->
              <div class="cs-portfolio_hover"></div>
              <span class="cs-plus"></span>
              <!-- <div class="cs-portfolio_bg cs-bg" data-src="assets/img/"></div> -->
              
                <h3 >Flutter Development</h3>
                <p style="text-align: justify;" style="color:">Mobile App Development at Plus IT Business Park in Thrissur is your pathway to the ever-evolving world of app creation. Our program focuses on Native App development, covering Kotlin and Jet Compose for Android and Swift for iOS, as well as cross-platform app development using the versatile frameworks React Native and Flutter. This immersive experience offers you the chance to navigate the expansive ocean of opportunities within the Mobile Application Development field. Through our project-oriented training and personalized one-on-one mentoring sessions, we provide the tools you need to confidently set sail on your career as a Mobile Application Developer, making your journey both exciting and rewarding.</p>
              <!-- <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Flutter Development</h2>
                <div class="cs-portfolio_subtitle">View Large</div>
              </div> -->
            <!-- </a> -->
             <div class="cs-height_90 cs-height_lg_40"></div>
            <a href="../internship/flutter_development.html" class="cs-text_btn">
              <span>More About Flutter Development</span>
              <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M25.5303 6.53033C25.8232 6.23744 25.8232 5.76256 25.5303 5.46967L20.7574 0.696699C20.4645 0.403806 19.9896 0.403806 19.6967 0.696699C19.4038 0.989593 19.4038 1.46447 19.6967 1.75736L23.9393 6L19.6967 10.2426C19.4038 10.5355 19.4038 11.0104 19.6967 11.3033C19.9896 11.5962 20.4645 11.5962 20.7574 11.3033L25.5303 6.53033ZM0 6.75H25V5.25H0V6.75Z" fill="currentColor"></path>
              </svg>
            </a>
          ...
          <div class="cs-isotop_item commercial">
            <!-- <a href="assets/img/portfolio_26_lg.jpeg" class="cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2"> -->
              ...
              <p style="text-align: justify;">A digital marketing internship is a chance for people to learn and obtain experience in the field of digital marketing. To market goods, services, or brands to a specific audience, digital marketing uses a variety of online tactics and platforms. This is a summary of what an internship in digital marketing entails. During a digital marketing internship, you'll delve into the intricacies of online marketing strategies and gain a comprehensive understanding of how businesses navigate the digital landscape. This hands-on experience provides a unique blend of creativity and data-driven decision-making.</p>
              <!-- <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
            ...
            <div class="cs-height_90 cs-height_lg_40"></div>
            <a href="../internship/digital_marketing.html" class="cs-text_btn">
              <span>More About Digital Marketing</span>
              <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M25.5303 6.53033C25.8232 6.23744 25.8232 5.76256 25.5303 5.46967L20.7574 0.696699C20.4645 0.403806 19.9896 0.403806 19.6967 0.696699C19.4038 0.989593 19.4038 1.46447 19.6967 1.75736L23.9393 6L19.6967 10.2426C19.4038 10.5355 19.4038 11.0104 19.6967 11.3033C19.9896 11.5962 20.4645 11.5962 20.7574 11.3033L25.5303 6.53033ZM0 6.75H25V5.25H0V6.75Z" fill="currentColor"></path>
              </svg>
            </a>
        ...
        <div class="cs-tabs cs-style1">
          <div class="cs-tabs_heading">
            <div class="cs-section_heading cs-style1">
              ...
              <h2 class="cs-section_title"> Providing best <br>pricing for Students </h2>
            </div>
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="cs-pricing_table cs-style1">
                    <h2 class="cs-pricing_title">Digital Marketing</h2>
                    <div class="cs-pricing_info">
                      <div class="cs-price">
                        <h3 class="cs-white_color">Rs:- 3000/-</h3>
                        <span class="cs-accent_color">Monthly</span>
                      </div>
                      <div class="cs-price_text">4 Month Program <br>With Certification</div>
                    ...
                    <ul class="cs-pricing_feature cs-mp0">
                      <li>
                        ...
                        <span>Wordpress / Mobirise / Canva</span>
                      </li>
                      <li>
                        <span class="cs-feature_icon cs-accent_color">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <li>
                        ...
                        <span>Whats App Bulk Message</span>
                      </li>
                      <li>
                        <span class="cs-feature_icon cs-accent_color">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <li>
                        ...
                        <span>Remarketing / Retargeting (Facebook Pixel)</span>
                      </li>
                      <li>
                        <span class="cs-feature_icon cs-accent_color">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="cs-pricing_btn_wrap">
                      <a href="../payment-form.html" class="cs-text_btn">
                ...
                <div class="col-lg-4">
                  <div class="cs-pricing_table cs-style1">
                    <h2 class="cs-pricing_title">Flutter Development</h2>
                    <div class="cs-pricing_info">
                      <div class="cs-price">
                        <h3 class="cs-white_color">Rs:- 5000/-</h3>
                        <span class="cs-accent_color">Monthly</span>
                      </div>
                      <div class="cs-price_text">6 Month Program <br> With Certification</div>
                    </div>
                    <ul class="cs-pricing_feature cs-mp0">
                      <li>
                        <span class="cs-feature_icon cs-accent_color">
                      ...
                      <li>
                        ...
                        <span>Material Design Widget Development</span>
                      </li>
                      <li>
                        <span class="cs-feature_icon cs-accent_color">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span>Flutter Flow Training</span>
                      </li>
                      <li>
                        <span class="cs-feature_icon cs-accent_color">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-4">
                  <div class="cs-pricing_table cs-style1">
                    <h2 class="cs-pricing_title">Web Development</h2>
                    <div class="cs-pricing_info">
                      <div class="cs-price">
                        <h3 class="cs-white_color">Rs:- 3000/-</h3>
                        <span class="cs-accent_color">Monthly</span>
                    ...
                    <ul class="cs-pricing_feature cs-mp0">
                      ...
                      <li>
                        ...
                        <span>PHP Rest Web Service</span>
                      </li>
                      <li>
                        <span class="cs-feature_icon cs-accent_color">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="cs-pricing_table cs-style1">
                    ...
                    <div class="cs-pricing_info">
                      <div class="cs-price">
                        <h3 class="cs-white_color">RS:-15000/-</h3>
                        <span class="cs-accent_color">At a Time</span>
                      </div>
                      <div class="cs-price_text">4 Month Program <br>With Certification</div>
                    </div>
                    <ul class="cs-pricing_feature cs-mp0">
                ...
                <div class="col-lg-4">
                  <div class="cs-pricing_table cs-style1">
                    ...
                    <div class="cs-pricing_info">
                      <div class="cs-price">
                        <h3 class="cs-white_color">Rs:- 26000/-</h3>
                        <span class="cs-accent_color">At a Time </span>
                      </div>
                      <div class="cs-price_text">6 Month Program <br>With Certification</div>
                    </div>
                ...
                <div class="col-lg-4">
                  <div class="cs-pricing_table cs-style1">
                    ...
                    <div class="cs-pricing_info">
                      <div class="cs-price">
                        <h3 class="cs-white_color">Rs:- 25000/-</h3>
                        <span class="cs-accent_color">At a Time</span>
                      </div>
                      <div class="cs-price_text">6 Month Program <br>With Certification</div>
                    </div>
      ...
      <div class="container">
        <div class="cs-slider cs-style1 cs-gap-24">
          <div class="cs-slider_left">
            <div class="cs-section_heading cs-style1">
              <h3 class="cs-section_subtitle">Our Certification</h3>
              <h2 class="cs-section_title">Certificates</h2>
              <div class="cs-height_45 cs-height_lg_20"></div>
              ...
              <div class="cs-slider_container" data-autoplay="1" data-loop="1" data-speed="1000" data-center="0" data-variable-width="1" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="2" data-add-slides="3">
                <div class="cs-slider_wrapper">
                  <div class="cs-slide">
                    <div class="cs-post cs-style1">
                      <a href="blog-details.html" class="cs-post_thumb">
                        <img src="assets/img/certificate/demo.jpg" alt="Post">
                  ...
                  <div class="cs-slide">
                    <div class="cs-post cs-style1">
                      <a href="blog-details.html" class="cs-post_thumb">
                        <img src="assets/img/certificate/demo-1.jpg" alt="Post">
                        <div class="cs-post_overlay"></div>
                      </a>
                      <!-- <div class="cs-post_info">
                  ...
                  <div class="cs-slide">
                    <div class="cs-post cs-style1">
                      <a href="blog-details.html" class="cs-post_thumb">
                        <img src="assets/img/certificate/demo-2.jpg" alt="Post">
                        <div class="cs-post_overlay"></div>
                      </a>
                      <!-- <div class="cs-post_info">
    ...
    <div class="container">
      <div class="cs-section_heading cs-style1 text-center">
        <h3 class="cs-section_subtitle">For More Details Please</h3>
        <h3 class="cs-section_title wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s" style="font-size:22px;">Register Here</h3>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-xl-12 col-lg-6">
            ...
            <form id="cs-form" action="https://api.web3forms.com/submit" method="POST" class="row">
              ...
              <div class="col-sm-6">
                <label class="cs-primary_color">Address</label>
                <input type="text" class="cs-form_field" name="number" required>
                <div class="cs-height_20 cs-height_lg_20"></div>
              </div>
              <div class="col-lg-12">
                <label class="cs-primary_color">Description*</label>
