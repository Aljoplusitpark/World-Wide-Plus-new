...
<head>
  ...
  <!-- Site Title -->
  <title>Life At Plus IT Park</title>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="cs-hero cs-style5">
            <figure class="cs-swiper_parallax_bg" data-src="assets/img/event.jpeg"><img src="assets/img/event.jpeg" alt="Slider" class="cs-entity_img"></figure>
        ...
        <div class="swiper-slide">
          <div class="cs-hero cs-style5">
            <figure class="cs-swiper_parallax_bg" data-src="assets/img/eve.jpeg"><img src="assets/img/eve.jpeg" alt="Slider" class="cs-entity_img"></figure>
            <div class="cs-hero_text">
              <h2 class="cs-hero_title"> <br></h2>
              <!-- <a href="case-study.html" class="cs-btn cs-style1 cs-type1"><span></span></a> -->
            </div>
